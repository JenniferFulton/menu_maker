...
#     mon = models.ForeignKey(Recipe, related_name="mon_menus", null=True)
#     tues = models.ForeignKey(Recipe, related_name="tues_menus", null=True)
#     wed = models.ForeignKey(Recipe, related_name="wed_menus", null=True)
#     thrus = models.ForeignKey(Recipe, related_name="thurs_menus", null=True)
#     fri = models.ForeignKey(Recipe, related_name="fri_menus", null=True)
#     sat = models.ForeignKey(Recipe, related_name="sat_menus", null=True)
#     sun = models.ForeignKey(Recipe, related_name="sun_menus", null=True)
#     created_at = models.DateTimeField(auto_now_add=True)
#     updated_at = models.DateTimeField(auto_now_add=True)
    # objects = MenuManager()
